# Vision-controlled-mobile-robot-using-ROS
Designed and built a mobile robot in Gazebo, and programed with C++ nodes in ROS to chase the white color ball

![Overview](/video/demo.gif)  
## Overview  
